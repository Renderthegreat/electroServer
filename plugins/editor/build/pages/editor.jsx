...
function main(key, Server, Content, Host, runtime) {
  var host = new Host();
  Server.create("get", "/editor/pages/".concat(key, "/files"), /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
      var json, dirO, data, file, scanDir;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            scanDir = function _scanDir(dir) {
          ...
          case 3:
            json = new Content("text/json");
            dirO = __dirname.replace("plugins/editor/build/pages", "") + "server/";
            data = {};
            scanDir(dirO);
            json.contents(data);
            json.send(req, res);
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 18:
            file = req.query.file;
            _data2 = h("html", null, h("body", null, h("a", {
              href: req.path + "../"
            }, "<-", " back"), h("h1", null, "Editing ", file), h("br", null), h("form", {
              action: "api/modify"
            }, h("label", {
              "for": "fileData"
            }, "File data:"), h("textarea", {
